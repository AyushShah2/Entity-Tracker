...
//import com.orangthegreat.EntityTrackerClient;
...
//
//import static com.orangthegreat.EntityTrackerClient.testColor;
//
///**
...
//        return screen -> {
//            ConfigBuilder builder = ConfigBuilder.create().setTitle(Text.literal("Entity Tracker"));
//
...
//
//            //ConfigCategory entitiesList = builder.getOrCreateCategory(Text.literal("Entities"));
//            //entitiesList.addEntry(createFriendsList(entryBuilder));
//
//
...
//    {
//
//        settingsCategory.addEntry(entryBuilder.startDropdownMenu(Text.literal("Suggestion Random Int"), DropdownMenuBuilder.TopCellElementBuilder.of(10,
//                s -> {
//                    try {
//                        return Integer.parseInt(s);
//                    } catch (NumberFormatException ignored) {
...
//                entryBuilder.startColorField(Text.literal("Default Color"), testColor)
//                        .setSaveConsumer(color -> testColor = color)
//                        .build()
//        );
//        settingsCategory.addEntry(
//                entryBuilder.startBooleanToggle(Text.literal("Main Toggle"), configs.getSettings().isEnabled())
//                        .setSaveConsumer(toggled -> configs.getSettings().mainToggle())
//                        .setDefaultValue(false)
//                        .setTooltipSupplier(createToolTip("Toggle ON/OFF Highlighting"))
//                        .build()
//        );
//    }
////

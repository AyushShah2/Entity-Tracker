...
public class RenderBetterPipelines {
    // 3D Pipelines
    public static final RenderPipeline QUADS = RenderPipelines.register(RenderPipeline.builder()
            ...
            .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withLocation("pipeline/sbh_quads").build());
    ...
    public static final RenderPipeline TRIS = RenderPipelines.register(RenderPipeline.builder()
            ...
            .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withLocation("pipeline/sbh_tris").build());
    ...
    public static final RenderPipeline LINES = RenderPipelines.register(RenderPipeline.builder()
            ...
            .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withLocation("pipeline/sbh_lines").build());
    ...
    public static final RenderPipeline QUADS_GUI = RenderPipelines.register(RenderPipeline.builder()
            ...
            .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withLocation("pipeline/sbh_quads_gui").build());
    ...
    public static final RenderPipeline TEXTURED_QUADS_GUI = RenderPipelines.register(RenderPipeline.builder()
            ...
            .withLocation("pipeline/s_textured_quads_gui").withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
    ...
    public static final RenderPipeline TRIS_GUI = RenderPipelines.register(RenderPipeline.builder()
            ...
            .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withLocation("pipeline/sbh_tris_gui").build());
    ...
    public static final RenderPipeline LINES_GUI = RenderPipelines.register(RenderPipeline.builder()
            ...
            .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withLocation("pipeline/sbh_lines_gui").build());
}